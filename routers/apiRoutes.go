...
func SetupRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("GET /createpost", middleware.GetCookiesId(handlers.CreatePostHandler))
	...
	// user activity
	mux.HandleFunc("POST /newposts", middleware.GetCookiesId(handlers.NewPostHandler))
	mux.HandleFunc("POST /newcomment", middleware.GetCookiesId(handlers.NewCommentHandler))
	mux.HandleFunc("POST /reaction", middleware.GetCookiesId(handlers.ReactionHandler))
